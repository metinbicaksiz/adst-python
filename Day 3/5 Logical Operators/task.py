...
#
# NOTE: The warning for simplification is just a suggestion. You can consider it and chose it,
# or you can ignore it. In this lesson I wanted to show you the and, or and not logical operators.
