...
# converts a floating point number (with decimal places) into an integer (whole number).
#
# int(3.738492) # Becomes 3
#
# Rounding a Number
# However, if you want to round a decimal number to the nearest whole number using the
# traditional mathematical way, where anything over .5 rounds up and anything below rounds
...
# Assignment operators such as the addition assignment operator += will add the number on the
# right to the original value of the variable on the left and assign the new value to the variable.
#
# +=
#
# -=
